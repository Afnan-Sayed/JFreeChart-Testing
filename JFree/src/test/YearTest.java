...
public class YearTest {
    ...
    @Test
    public void testLastMillisecond_InvalidYearThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Year(1899).getLastMillisecond(Calendar.getInstance());
        });
    }
    ...
    @Test
    public void testEquals_InvalidYearThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            Year year1 = new Year(2025);
            Year year2 = new Year(10000); // Invalid
            year1.equals(year2);
        });

        assertThrows(IllegalArgumentException.class, () -> {
            Year year1 = new Year(1800); // Invalid
    ...
    @Test
    public void testYearOutOfRangeThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Year(10000); // Above the allowed max of 9999
        });

        assertThrows(IllegalArgumentException.class, () -> {
            new Year(1899); // Below the allowed min of 1900
        });
    }
    ...
    @Test
    public void testYearBelowRangeThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            Year.parseYear("0000");
        });
    ...
    @Test
    public void testYearAboveRangeThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
